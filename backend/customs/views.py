...
#     potential_volume = 0
#     del_import = 0
#     def export_to_exel(self, tnved_code, tnved_name, import_value, export_value, clean_exp_imp,
#                        clean_exp_imp_del, main_partners, customs_duties, sanctions, potential_volume, del_import):
